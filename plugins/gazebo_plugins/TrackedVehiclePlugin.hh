...
namespace gazebo
{
  ...
  class TrackedVehiclePlugin : public ModelPlugin
  {
    ...
    protected: boost::thread rosQueueThread;

    protected: std::string cmdVelTopicName;

    protected: void VelocityCallback(const geometry_msgs::TwistStamped::ConstPtr& cmd_msg);
    ...
    protected: virtual void OnVelMsg(const geometry_msgs::TwistStamped::ConstPtr& cmd_msg);
